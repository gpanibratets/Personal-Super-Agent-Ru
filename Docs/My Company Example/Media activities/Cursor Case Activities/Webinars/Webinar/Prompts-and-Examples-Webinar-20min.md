...
## 🎯 ДЕМО 3: Анализ встречи с клиентом (4 мин)

### Шаг 1: Анализируем транскрипт встречи с клиентом
...
Как это работает:
- Берет сложные транскрипты встреч и извлекает ключевые бизнес-решения
- Определяет ответственность и план действий с конкретными исполнителями
- Оценивает удовлетворенность клиента и состояние отношений
- Создает структурированный анализ для руководства
...
- Больше никакой путаницы "кто что сказал" после важных звонков с клиентами
- Четкая ответственность и следующие шаги
- Выявление рисков до того, как проблемы обострятся
- Аналитика уровня руководства без ручного анализа
...
* **2 занятия про аналитику:** "Как должна выглядеть маркетинговая аналитика в современном мире?"
  * Управленческая часть (воркшоп с воронками)
