...
> "Помоги мне организовать проект"  
...
AI: Нашёл проект gmail-fisher на GitHub
    ...
    → Интегрировал с вашими финансовыми данными
...
- *"Поищи готовые решения для автоматизации задач"*
...
# Домашние проекты
"Поищи готовые решения для управления домашними проектами"
